...
public class CraftWater extends Task{
	...
	public boolean activate() {
		Tile air_b1 = new Tile(3195, 3445, 0); // area check if in varrock west bank (need fix)
	...
	public void execute() 
	{
		...
		Tile water_a2 = new Tile(3178, 3180, 0);
		Area alter_area = new Area(water_a1, water_a2);
		
		Tile water_I = new Tile(3493, 4832, 0); // area for place inside alter to check if in alter (need fix)
		Tile water_I1 = new Tile(3503, 4842, 0);
		Tile water_I2 = new Tile(3483, 4822, 0);
		Area alter_inside = new Area(water_I1, water_I2);
		
		Tile water_b = new Tile(3093, 3243, 0); // area for inside bank (need fix)
