...
import needscroll.LimpwurtGrabber.Tasks.WalkBank;
...
@Script.Manifest(name = "Limpwurtroot Grabber v2", description = "Collects Limpwurtroots", properties = "author=needscroll; topic=1336613; client=6;")
...
public class LimpwurtGrabber extends PollingScript<ClientContext> implements PaintListener{
	...
	public void start()
	{
		...
		String banks [] = {"teleport", "walking"};
		String bank_choice = (String) JOptionPane.showInputDialog(null, "How do you wish to bank?","teleport",JOptionPane.PLAIN_MESSAGE, null, banks,banks[0]);
		
		if (bank_choice == "teleport")
		{
