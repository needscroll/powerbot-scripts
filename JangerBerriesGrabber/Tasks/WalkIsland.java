...
public class WalkIsland extends Task{
	...
	final static int[] BOUNDS = {-128, 128, -1700, -1900, -128, 128}; // old one
	final static int[] BOUNDS1 = {-44, 24, -1718, -1910, -132, 272}; // new one
	...
	private void swing_island()
	{
		...
		GameObject branch = ctx.objects.select().id(BRANCH).each(Interactive.doSetBounds(BOUNDS1)).nearest().poll();
