...
public class SlaveTrade extends Action{
	...
	public void execute() {
		...
		if (!CONSTANTS.fally_bank_area.contains(ctx.players.local()))
		{
			...
			{
				step_use_object(CONSTANTS.island_gangplank_tile, CONSTANTS.gangplank, CONSTANTS.gangplank_interact);
			}
			...
			{
				use_object(CONSTANTS.gangplank, CONSTANTS.gangplank_interact);
			}
