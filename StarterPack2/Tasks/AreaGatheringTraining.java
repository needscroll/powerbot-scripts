...
public class AreaGatheringTraining extends Powering{
	
	TrainingMap map;

	public AreaGatheringTraining(ClientContext ctx, int[] object, int[] product, String interact, TrainingMap map) {
